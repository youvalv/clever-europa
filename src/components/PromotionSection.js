...
import {toStyleObj, withPrefix, Link} from '../utils';
        ...
        return (
            <section className="content__row content__row--full-width content__row--mb-0"  data-id={_.get(section, 'section_id', null)}>
                <div className="promo">
                    ...
                    <div className="promo__message-container"  style={toStyleObj('background-image: url(' + withPrefix(_.get(this.props, 'data.config.bg_image_product', null)) + ')')}>
                        ...
                        <Link className="link link--light promo__link" href={_.get(section, 'cta.url', null)}>
